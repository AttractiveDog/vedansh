            ...
            <section id="contacts" className="contacts-section">
                <div className="contacts-container container to-slide up">
                    <div className="contacts-text">
                        <h3>Get in touch </h3>
                        <p className="mail-contacts">If you want to get in touch with me for any reason, may it be about work or just to say hi, send me a mail at <a className="mail-link" href="mailto:vedanshm41@gmail.com">vedanshm41@gmail.com</a> and I will get back to you as soon as possible.</p>
                    </div>
